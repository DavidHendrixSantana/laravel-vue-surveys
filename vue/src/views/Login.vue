  ...
  <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit="login">
        ...
        <div v-if="errorMsg" class ="flex items-center justify-between py-3 px-5 bg-red-500 text-white " >
          {{errorMsg}}
          <span @click="errorMsg=''" class="rounded-full transition-colors cursor-pointer hover:bg-slate-700">
