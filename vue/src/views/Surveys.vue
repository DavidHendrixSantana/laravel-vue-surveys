    ...
    <PageComponent > 
        <template v-slot:header>
            <div class="flex justify-between items-center">
                ...
                class="h-4 w-4 -mt-1 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor" 
                stroke-width="2">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
                    ...
                    class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 h-[470px]">
                        ...
                        <div class="flex justify-between items-center mt-3">
                            ...
                            class="flex py-2 px-4 border border-transparent text-sm rounded-md text-white bg-indigo-700 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" >
...
function deleteSurvey(survey){
    if (confirm('Are you sure you want to delte this survey? Operation can not be undone!!')){
        // Delete Survey
    } 
}
